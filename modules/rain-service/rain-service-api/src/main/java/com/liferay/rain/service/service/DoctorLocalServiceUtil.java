 ...
 * <code>com.liferay.rain.service.service.impl.DoctorLocalServiceImpl</code> and
...
public class DoctorLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.rain.service.service.impl.DoctorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Doctor createDoctor(long employeeId) {
		return getService().createDoctor(employeeId);
	}
	 ...
	 */
	public static Doctor deleteDoctor(Doctor doctor) {
	 ...
	 */
	public static Doctor deleteDoctor(long employeeId) throws PortalException {
		return getService().deleteDoctor(employeeId);
	}
	...
	public static Doctor fetchDoctor(long employeeId) {
		return getService().fetchDoctor(employeeId);
	}
	 ...
	 * @throws PortalException if a doctor with the primary key could not be found
	 */
	public static Doctor getDoctor(long employeeId) throws PortalException {
		return getService().getDoctor(employeeId);
	}
	 ...
	 */
	public static List<Doctor> getDoctors(int start, int end) {
	...
	private static volatile DoctorLocalService _service;
