 ...
 * <code>com.liferay.rain.service.service.impl.PatientLocalServiceImpl</code> and
...
public class PatientLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.rain.service.service.impl.PatientLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Patient createPatient(long govtId) {
		return getService().createPatient(govtId);
	}
	 ...
	 */
	public static Patient deletePatient(long govtId) throws PortalException {
		return getService().deletePatient(govtId);
	}
	...
	public static Patient fetchPatient(long govtId) {
		return getService().fetchPatient(govtId);
	}
	 ...
	 * @throws PortalException if a patient with the primary key could not be found
	 */
	public static Patient getPatient(long govtId) throws PortalException {
		return getService().getPatient(govtId);
	}
