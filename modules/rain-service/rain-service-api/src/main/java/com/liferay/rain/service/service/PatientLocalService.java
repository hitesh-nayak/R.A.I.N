...
public interface PatientLocalService
	...
	public Patient createPatient(long govtId);
	...
	public Patient deletePatient(long govtId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Patient fetchPatient(long govtId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Patient getPatient(long govtId) throws PortalException;
