...
const Blog = () => {
  ...
  const deleteArticle = () => {
    if (id) {
      blogsDelete(id).then((Response) => console.log(Response.status));
  ...
  const createArticle = () => {
    if (uId && updateVal == "update") {
      blogsUpdate(uId, JSON.stringify(article)).then((json) => {
        console.log(json);
        depArr = [...data, json];
        console.log(depArr);
      });
      ...
      blogsPost(JSON.stringify(article)).then((json) => {
        console.log(json);
        depArr = [...data, json];
        console.log(depArr);
      });
